...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'employee', 'manager', 'hr-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Birthdays', path: '/birthdays', entity: 'birthday', service: AccessServiceEnum.PROJECT, icon: FiGift },
    ...
    { name: 'Rewards', path: '/rewards', entity: 'reward', service: AccessServiceEnum.PROJECT, icon: FiAward },
